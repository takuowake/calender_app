...
class _$_TempPlanItemData implements _TempPlanItemData {
  ...
  @override
  String toString() {
    return 'TempPlanItemData(title: $title, comment: $comment, isAll: $isAll, startDate: $startDate, endDate: $endDate)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.isAll, isAll) || other.isAll == isAll) &&
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, title, comment, isAll, startDate, endDate);
